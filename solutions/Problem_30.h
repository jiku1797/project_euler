...
inline underlying_t problem_30()
{
  ...
  // There can't be a number with 7 digits (or more) which fulfils the condition
  // for exponent equal to 5 since if all digits are 9, then
  // sum of 5:th powers of digits = 7 * 9^5 = 413343 is only 6 digits long
